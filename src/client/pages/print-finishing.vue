<template>
  <article class="print-finishing center-content rich-text">
    ...
    <p class="body">
      All photo prints can be purchased for the sizes <strong>30x40 cm</strong>,
      <strong>40x50 cm</strong> and <strong>100x120 cm</strong>. Finish options
      are: <strong>Dibond</strong>, <strong>Plexiglass</strong> and
    ...
    <ul class="body">
      ...
      <li>Very lightweight metal.</li>
      <li>Will never get weather or rusted.</li>
    </ul>
  </article>
</template>
...
@media (min-width: 600px) {
  .print-finishing__table-data {
    width: 550px;
    max-width: none;
  }

  .print-finishing__table-data .table-data__cell:first-child {
    width: 160px;
  }
}
</style>
